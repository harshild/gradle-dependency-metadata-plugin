...
class DependencyManagerTest {
    ...
    @Test
    void itShouldReturnASetOfResolvedDependenciesForConfiguration() throws Exception {
        Set<ResolvedArtifact> artifacts = dependencyManager.getResolvedArtifacts("compile")
        assertEquals(2,artifacts.size())
    }

    @Test
    void itShouldReturnASetOfResolvedDependenciesForConfigurationIncludingTransitiveDependencies() throws Exception {
    ...
    @Test
    void itShouldReturnASetOfResolvedDependenciesForSubProjectsAlso() throws Exception {
    ...
    @Test
    void itShouldResolveDependencyForAllConfigurations() throws Exception {
    ...
    @Test
    void itShouldResolveDependencyForSelectiveConfigurations() throws Exception {
        GradleTestHelper.addDependency(testProject,"testCompile",ARTIFACT_1_GROUP,ARTIFACT_1_NAME,ARTIFACT_1_VERSION)
