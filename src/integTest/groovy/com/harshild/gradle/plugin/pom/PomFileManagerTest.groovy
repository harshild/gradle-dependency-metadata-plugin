...
class PomFileManagerTest {
    ...
    @Test
    void should_fetch_POMFile_location_forArtifact() throws IOException {
    ...
    @Test
    void should_fetch_Map_Of_POMFiles_forSelectedArtifacts() throws IOException {
    ...
    @Test
    void should_fetch_Map_Of_POMFiles_forArtifacts() throws IOException {
    ...
    @Test
    void itShouldFetchPOMFileURLForDependency() throws IOException {
